...
const contains = (arr, nameFive, cb) => {
  if(arr.includes(nameFive)){
    cb(true)
  } else {
    cb(false)
  }
...
//const numsOne = [1,2,3,4,5,6,7,8,7,6,5,4,3,2,1];
const numsOne = [1,2,3,4,5,6,7,8,7,6,5,4,4,3,2,1];
uniq(numsOne);
console.log(numsOne);
// const uniq = (arr, cb) => {
//   let uniqArr = [];
...
const nameLogger = (uniqArr) => console.log(`The new names array with all the duplicate items removed is ${uniqArr}.`)

uniq(names, nameLogger)
...
const nums = [1,2,3,4,5,6,7,8,7,6,5,4,3,2,1];
